...
class Settings(BaseSettings):
    ...
    ON_DEMAND_EARTHQUAKE_SOCKET: str = "/tmp/on_demand_earthquake.sock"
    ...
    animation:      FeedBasedConfig| None = Field(default=None, json_schema_extra=TomlMetadata())
    entertainment:  FeedBasedConfig| None = Field(default=None, json_schema_extra=TomlMetadata())
    culture:        FeedBasedConfig| None = Field(default=None, json_schema_extra=TomlMetadata())
    technology:     FeedBasedConfig| None = Field(default=None, json_schema_extra=TomlMetadata())
    science:        FeedBasedConfig| None = Field(default=None, json_schema_extra=TomlMetadata())
